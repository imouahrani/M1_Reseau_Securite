...
{ 
   ...
   // généré à l'aide de la clé
    ...
    { 
	    ...
	    String Ciphertext = new Scanner(System.in).nextLine();
	    ...
	    String strWP =  Ciphertext.replaceAll("[\\str\\p{Punct}]","");
        System.out.println("Ciphertext without ponctuations and spaces : "+strWP); 
	    ...
	    String str = originalText(strWP, key).toLowerCase(); 


	    System.out.println("Original/Decrypted Text : "+str ); 
    } 
} 
